...
namespace ChristmasWithTypes
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            xmas.Presents =  new string[3]{"Playstation 5", "AMD Threadripper (of sorts)", "Babysitter for these kids that keep screaming while I am trying to fill out this thing. LOL"}; 
